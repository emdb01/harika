...
<html lang="en">
    ...
    <div id="page">
        ...
        <div class="page-header">
            <div class="container">
                <div class="col-md-12">
                    <h1 class="title">Registration / Login Page</h1>
                </div>
                <div class="breadcrumb-box">
                    <div class="container">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Registration /Login Page</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <section class="page-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">Lorem ipsum dolor sit amet, consectetur adipisicing elit. consequuntur ex eligendi minima voluptatem assumenda voluptas quidem sit maiores odio velit voluptate. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repudiandae odit iste exercitationem praesentium deleniti nostrum laborum rem id nihil tempora.</div>
                </div>
                <hr />
                <div class="row">
                    <div class="content col-sm-12 col-md-8" style="background: rgba(228, 228, 228, 0.84);
    padding: 20px;">
                        <form id="contact-form" class="contact-form" method="post">
                        <h3 class="title" style="    font-family: Oswald,sans-serif;
    border-bottom: 1px solid #28292b;
    padding-bottom: 21px;
    text-align: center;">Don&#39;t have an Account? Register Now.</h3>
                        <div id="success"></div>
                        <div class="col-md-5"> 
						<div class="left" style="" >
						<h6>Take it with you everywhere</h6><img src="img/rec.png"></div></div>
						 <div class="col-md-7">
				...
				<label class="radio-inline">
				  <input type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2"> Recruiter</label>
						...
						<input id="phone" type="tel" placeholder="Enter Country" id="exampleInputEmail1" class="form-control">
					  </div>
                            </div>
				  ...
				  <input type="checkbox" id="inlineCheckbox1" value="option1"> Skip (Phone Verification Required )
					...
					<label for="exampleInputEmail1" style="display:block">Type the text</label></div>
                                <div class="captcha col-md-6 col-xs-6 col-sm-6" style="display:block">
...
<div class=""  style="float:left;width:50%">
						<input id="phone" type="tel" placeholder="Enter the text"  class="form-control"></div><div class=""  style="display:inline;margin-left:20px;width:50%;"><span style="margin-right:10px;" class="icon-refresh8"></span>	 
						...
						<div class="clearfix"></div>
                            <div class="col-md-12">
                                <div class="form-group">
					<label class="checkbox-inline">
				  <input type="checkbox" id="inlineCheckbox1" value="option1"> I agree to the terms and conditions polic
				</label>
					  </div>
                            </div>
                           <div class="clearfix"></div>
       ...
       <footer id="footer">
                ...
                <div class="copyright dark-section">
                    <div class="container">
                        <div class="row">
                            <!-- Copyrights -->
                            <div class="col-xs-10 col-sm-6 col-md-6"> <b>© 2017 trubizpartners.com.</b> </div>
